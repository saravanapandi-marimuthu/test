...
export const AccountEnterprises: React.FC<{
  ...
  const columns: Column[] = [
    {
      ...
      options: {
        ...
        customBodyRender: (
          ...
          const enterpriseCompanyId = displayData[rowIndex].company.id
          const enterpriseName = displayData[rowIndex].company.name

          return (
            <Link to={`/enterprises/${enterpriseCompanyId}/${enterpriseName}`}>
              {enterpriseName}
            </Link>
          )
        },
  ...
  return (
    ...
    >
      ...
      >
        <LinkCompanies
          autoCompleteLabel="Search Enterprises"
          companyId={companyId || ''}
          ...
          relationshipDirection={CompanyRelationshipDirection.PrimaryToRelated}
